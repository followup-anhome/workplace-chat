  ...
  return (
    <div style={{ minHeight: "100dvh", background: "linear-gradient(160deg, #0f2d5c 0%, #1a4a8a 50%, #0f2d5c 100%)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "16px" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: "20px" }}>
        <div style={{ fontSize: "11px", color: "#93c5fd", letterSpacing: "3px", fontFamily: "Helvetica, sans-serif", marginBottom: "4px" }}>POWERED BY</div>
        <div style={{ fontSize: "48px", fontWeight: 900, color: "white", fontFamily: "Helvetica, sans-serif", letterSpacing: "6px", lineHeight: 1 }}>UNO</div>
        <div style={{ fontSize: "10px", color: "#bfdbfe", letterSpacing: "2px", fontFamily: "Helvetica, sans-serif", marginTop: "2px" }}>OVERSEAS PLACEMENT, INC.</div>
        <div style={{ width: "50px", height: "2px", background: "#f59e0b", margin: "8px auto" }}></div>
        <div style={{ fontSize: "11px", color: "#e0f2fe", fontFamily: "Helvetica, sans-serif", letterSpacing: "1px" }}>Workplace Communication Tool</div>
      </div>
      ...
      <div style={{ backgroundColor: "white", borderRadius: "20px", padding: "28px 24px", width: "100%", maxWidth: "360px", boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}>
        <div style={{ textAlign: "center", marginBottom: "16px" }}>
          <div style={{ display: "flex", justifyContent: "center", marginBottom: "4px" }}>
            <Image src="/followup-logo.png" alt="Follow Up Co., Ltd." width={80} height={80} style={{ borderRadius: "50%" }} />
          </div>
          <h1 style={{ fontSize: "17px", fontWeight: 700, color: "#0f2d5c", margin: "8px 0 0", fontFamily: "Helvetica, sans-serif" }}>Workplace Chat</h1>
          <p style={{ fontSize: "11px", color: "#6b7280", marginTop: "3px", fontFamily: "Helvetica, sans-serif" }}>職場チャット — AI自動翻訳</p>
        </div>
      ...
      <div style={{ marginTop: "16px", textAlign: "center" }}>
        <p style={{ fontSize: "10px", color: "#60a5fa", fontFamily: "Helvetica, sans-serif", margin: 0 }}>In partnership with Follow Up Co., Ltd.</p>
        <p style={{ fontSize: "9px", color: "#93c5fd", fontFamily: "Helvetica, sans-serif", margin: "2px 0 0" }}>Philippine and Japan Cross Linking</p>
      </div>
    </div>
  );
}
